...
const User1 = new User("Davide", "Paderi", "25", "Muravera");

const User2 = new User("Giovanni", "Muciaccia", "55", "Napoli");
...
const Owner1 = new Pet("doggo", "Davide", "cane", "carlino");
const Owner2 = new Pet("paolina", "Luca", "cane", "labrador");
